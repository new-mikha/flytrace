            ...
            <table style="text-align: left">
                        ...
                        <asp:ChangePassword Width="100%" ID="changePasswordControl" runat="server" CssClass="GroupTable" ContinueDestinationPageUrl="~/default.aspx">
                            <ChangePasswordTemplate>
                                <table cellpadding="1" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        <td class="VisualGroupTitle" colspan="2">Password
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                            ...
                            <SuccessTemplate>
                                <table cellpadding="1" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        <td class="VisualGroupTitle">Password for <i>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" class="GroupTable">
                            <tr>
                                <td class="VisualGroupTitle">Email
                                </td>
                            </tr>
                            <tr>
                                <td>
                                        ...
                                        <WizardSteps>
                                            <asp:WizardStep runat="server">
                                                <table style="width: 100%">
                                                    <tr>
                                                        <td colspan="2">If you wish to change your email, please
                                                        <br />
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" class="GroupTable">
                            <tr>
                                <td class="VisualGroupTitle">Events Mode
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" class="GroupTable">
                            <tr>
                                <td class="VisualGroupTitle">Altitude display mode
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p>
                                        Some tracker models (e.g. SPOT Gen3) can translate <br />
                                        us their altitude. When it's available, the altitude can<br />
                                        be shown on your maps.
                                    </p>
                                    <asp:Wizard ID="altitudeModeWizard"
                                        runat="server"
                                        DisplaySideBar="False"
                                        StartNextButtonText="Change altitude display mode"
                                        FinishCompleteButtonText="Continue"
                                        OnFinishButtonClick="anyWizard_FinishButtonClick"
                                        Width="100%"
                                        FinishPreviousButtonText="Change altitude display mode again"
                                        OnNextButtonClick="altitudeModeWizard_NextButtonClick">
                                        <StartNavigationTemplate>
                                            <asp:Button ID="StartNextButton" runat="server" CommandName="MoveNext" Text="Change Altitude Display Mode" />
                                        </StartNavigationTemplate>
                                        <WizardSteps>
                                            <asp:WizardStep ID="WizardStep3" runat="server">
                                                <asp:RadioButton GroupName="altitudeDisplayMode"
                                                    Checked="true"
                                                    runat="server"
                                                    ID="hideAltitudeRadioButton"
                                                    Text="Do not show altitude on your maps" />
                                                <br />
                                                <br />
                                                <asp:RadioButton GroupName="altitudeDisplayMode"
                                                    Checked="true"
                                                    runat="server"
                                                    ID="showAltitudeAsFeetRadioButton"
                                                    Text="Show altitude on your maps in Feet" />
                                                <br />
                                                <span style="font-size: small">&nbsp;&nbsp;&nbsp;&nbsp;When available, altitude will be shown as FT for trackers that<br/>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;send it.</span>
                                                <br />
                                                <br />
                                                <asp:RadioButton GroupName="altitudeDisplayMode"
                                                    Checked="true"
                                                    runat="server"
                                                    ID="showAltitudeAsMeterstRadioButton"
                                                    Text="Show altitude on your maps in Kilometers" />
                                                <br />
                                                <span style="font-size: small">&nbsp;&nbsp;&nbsp;&nbsp;When available, altitude will be shown as KM for trackers that<br/>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;send it.</span>
                                                <br />
                                            </asp:WizardStep>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" class="GroupTable">
                            <tr>
                                <td class="VisualGroupTitle">Showing owner-defined messages by default
                                </td>
                            </tr>
                            <tr>
                                <td>
