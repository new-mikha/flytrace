...
CopyByRelPath 'Tracker\Service\bin\LocationLib.dll'
CopyByRelPath 'Tracker\Service\bin\LocationLib.pdb'
CopyByRelPath 'Tracker\Service\bin\Service.dll'
CopyByRelPath 'Tracker\Service\bin\Service.pdb'